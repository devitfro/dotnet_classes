...
namespace icompare
{
    class Student
    {
        ...
        // homework
        public double AverageMark => _gradesExam.Count > 0 ? _gradesExam.Average() : 0;
        // Сортировка по среднему баллу
        public class StudentComparerByAverageMark : IComparer<Student>
        {
            public int Compare(Student x, Student y) => y.AverageMark.CompareTo(x.AverageMark);
        }
        ...
        public class StudentComparerByName : IComparer<Student>
        {
            ...
            {
                int lastNameComparison = x._surname.CompareTo(y._surname);
                return lastNameComparison != 0 ? lastNameComparison : x._name.CompareTo(y._name);
            }
        }
    }
}
