...
class Group
{
    ...
    public string GroupName
    {
        ...
        set
        {
            ...
            {
                Console.WriteLine("Group name cannot be null or empty.");
                return;
            }
            _groupName = value;
        }
    ...
    public string GroupSpecialist
    {
        ...
        set
        {
            if (string.IsNullOrWhiteSpace(value))
            {
                Console.WriteLine("Specialisation cannot be null or empty.");
                return;
            }
    ...
    public int CourseNumber
    {
        ...
        set
        {
            if (value < 1 || value > 5)
            {
                Console.WriteLine("Course number must be between 1 and 5.");
                return;
            }
            _courseNumber = value;
        }
